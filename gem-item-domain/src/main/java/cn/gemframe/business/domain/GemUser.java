...
public class GemUser extends BaseBean {
	...
	private @Column(name="member_name",cause="真实姓名",		columnDefinition = "varchar(255) COMMENT '真实姓名'") 			String memberName;
	...
	private @Column(name="cause",cause="备注",					columnDefinition = "varchar(255) COMMENT '备注'") 				String cause;
